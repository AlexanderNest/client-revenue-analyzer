...
public class EventsAnalyzerControllerTest extends AbstractControllerTest {
    ...
    void init() {
        ...
        when(googleCalendarClient.getEventsBetweenDates(eq("someCalendar1"), CalendarType.PLAIN, any(), any())).thenReturn(List.of(eventDto1, eventDto2, eventDto3, eventDto4, eventDto5, eventDto6, eventDto7, eventDto8));
    }
